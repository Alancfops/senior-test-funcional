...
- Em cada um: **(I) Independente**, **(A) Assistência**, **(D) Dependente**, com texto de apoio conforme protocolo (vide [../clinical-protocols/instruments/katz/assess.md](../clinical-protocols/instruments/katz/assess.md)).  
...
**MEEM**  
- Blocos na ordem do protocolo adotado (Folstein; referências em [../clinical-protocols/instruments/meem/](../clinical-protocols/instruments/meem/)).  
...
- Protocolos e pontos de corte: ver **[../clinical-protocols/instruments/](../clinical-protocols/instruments/)** (cada subpasta traz referência bibliográfica no `assess.md` ou no resumo `*.md`).  
...
- Outras fontes por instrumento: Podsiadlo & Richardson (TUG); Tinetti (1986); Katz et al. (1963); Berg et al. (1992); Miyamoto et al. (versão brasileira da Berg), conforme citado nos roteiros em [../clinical-protocols/instruments/](../clinical-protocols/instruments/).

---

*Documento revisado para alinhar numeração dos RFs, fluxo instrumento → paciente, regras de cálculo (MEEM e Katz), escolaridade no cadastro com uso no MEEM, e anexo técnico em [../clinical-protocols/instruments/](../clinical-protocols/instruments/). Conteúdo sujeito a alterações.*
