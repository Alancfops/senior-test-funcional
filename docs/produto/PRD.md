...
A numeração completa com tabelas de campos e regras está em **[levantamento-requisitos.md](./levantamento-requisitos.md)** (seções dos RF001 ao RF013). Abaixo, mapa sintético.
