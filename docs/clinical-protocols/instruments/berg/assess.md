...
Texto dos **14 itens** e critérios **0–4** conforme versão brasileira publicada por **Miyamoto et al. (2004)**. Para revisão de uso da escala em contexto clínico, ver **Blum & Korner-Bitensky (2008)**; publicação original do instrumento: **Berg et al. (1992)**.

## 1) O que é
A Escala de Equilíbrio de Berg é um instrumento composto por **14 itens**, que avalia equilíbrio estático e dinâmico por meio de tarefas funcionais. Cada item é pontuado de **0 a 4**, onde **0** indica incapacidade de completar a tarefa e **4** indica execução independente.

## 2) Como pontuar (regra geral)

- Cada item: **0–4 pontos**
- **Escore total máximo: 56 pontos**
- Quanto maior o escore, melhor o equilíbrio funcional.

## 3) Itens, instruções e critérios de pontuação (0–4)
...
**Instruções:** Arrume as cadeiras perpendicularmente ou uma de frente para a outra para uma transferência em pivô.  
Peça ao paciente para transferir-se de uma cadeira com apoio de braço para uma cadeira sem apoio de braço, e vice-versa.  
...
(O examinador posiciona a régua no fim da ponta dos dedos quando o braço estiver a 90º. Ao serem esticados para frente, os dedos não devem tocar a régua.  
A medida a ser registrada é a distância que os dedos conseguem alcançar quando o paciente se inclina para frente o máximo que ele consegue.  
...
Faça o mesmo por cima do ombro direito. (O examinador poderá pegar um objeto e posicioná-lo diretamente atrás do paciente para estimular o movimento)
...
- **4:** Capaz de levantar uma perna independentemente e permanecer por >10 seg.
- **3:** Capaz de levantar uma perna independentemente e permanecer por 5-10 seg.
- **2:** Capaz de levantar uma perna independentemente e permanecer por ≥ 3 seg.
...
- Identificação do paciente (nome, prontuário se houver, idade, sexo)
- Diagnóstico (texto)
- Lado dominante/parético (D/E)
- Data da avaliação
- Avaliador
- Pontuação de cada item (1–14)
- Escore total calculado automaticamente
- Observações (texto livre)

## 6) Referências

1. Berg KO, Wood-Dauphinee SL, Williams JI, Maki B. Measuring balance in the elderly: validation of an instrument. Can J Public Health. 1992.
2. Miyamoto ST, et al. Brazilian version of the Berg balance scale. Braz J Med Biol Res. 2004.
3. Blum L, Korner-Bitensky N. Usefulness of the Berg Balance Scale in stroke rehabilitation: a systematic review. Phys Ther. 2008.