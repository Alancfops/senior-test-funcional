...
import { BERG_GENERAL_SCORE_LABELS } from '@/features/assessments/score-labels';

const bergNumeric = { kind: 'numeric' as const, min: 0, max: 4, scoreLabels: BERG_GENERAL_SCORE_LABELS };
